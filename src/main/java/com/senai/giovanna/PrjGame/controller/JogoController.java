package com.senai.giovanna.PrjGame.controller;
...
import com.senai.giovanna.PrjGame.service.JogoService;
...
public class JogoController {
	...
	private final JogoService jogoServico;
	...
	public ResponseEntity<List<Jogo>> getAllJogos(RequestEntity<Void> requestEntity) {
		...
		List<Jogo> jogos = jogoServico.getAllJogos();
	...
	public Jogo updateJogo(@PathVariable Long id, @RequestBody Jogo jogo) {
		return jogoServico.updateJogo(id, jogo);
	}
